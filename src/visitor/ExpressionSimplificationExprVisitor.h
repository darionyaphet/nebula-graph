...
#ifndef VISITOR_EXPRESSIONSIMPLIFICATIONEXPRVISITOR_H_
#define VISITOR_EXPRESSIONSIMPLIFICATIONEXPRVISITOR_H_
...
class ExpressionSimplificationExprVisitor final : public ExprVisitor {
public:
...
#endif   // VISITOR_EXPRESSIONSIMPLIFICATIONEXPRVISITOR_H_
